...
import com.edammo.hermes.Hermes.*;

public class TWSConnection implements ApiController.IConnectionHandler {
    ...
    private void place_orders(ArrayList<HermesContractOrder> contract_orders_list){
        for(HermesContractOrder co: contract_orders_list) {
            m_controller.placeOrModifyOrder(co.c, co.o, new ApiController.IOrderHandler() {
                @Override
